export default {
  ...
  'pages.home.title': 'Favorite Boards',
  'pages.home.empty': 'No favorite boards',
  'pages.board.favorite.add': 'Add to favorites',
  'pages.board.favorite.remove': 'Remove from favorites',
  'pages.task.complete': 'Mark as complete',
  'pages.task.incomplete': 'Mark as incomplete',
  'pages.task.description': 'Description',
  'pages.task.dates': 'Dates',
  'pages.task.startDate': 'Start Date',
  'pages.task.endDate': 'End Date',
  'pages.task.attachments': 'Attachments',
  'pages.task.addFile': 'Add file',
  'pages.task.uploading': 'Uploading...',
  'pages.task.download': 'Download',
  'pages.task.delete': 'Delete',
  'pages.task.error.noId': 'Error: Task ID not found',
  'pages.task.error.notFound': 'Task not found',
